 ...
 */
export declare function instanceOfFlowStageBinding(value: object): value is FlowStageBinding;
export declare function FlowStageBindingFromJSON(json: any): FlowStageBinding;
export declare function FlowStageBindingFromJSONTyped(json: any, ignoreDiscriminator: boolean): FlowStageBinding;
export declare function FlowStageBindingToJSON(json: any): FlowStageBinding;
export declare function FlowStageBindingToJSONTyped(value?: Omit<FlowStageBinding, 'pk' | 'policybindingmodel_ptr_id' | 'stage_obj'> | null, ignoreDiscriminator?: boolean): any;
