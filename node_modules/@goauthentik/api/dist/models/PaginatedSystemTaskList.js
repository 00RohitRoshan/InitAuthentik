...
exports.PaginatedSystemTaskListToJSONTyped = PaginatedSystemTaskListToJSONTyped;
...
function PaginatedSystemTaskListToJSON(json) {
    return PaginatedSystemTaskListToJSONTyped(json, false);
}
function PaginatedSystemTaskListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PaginatedSystemTaskList.js.map