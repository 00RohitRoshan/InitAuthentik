...
exports.GoogleWorkspaceProviderGroupToJSONTyped = GoogleWorkspaceProviderGroupToJSONTyped;
...
function GoogleWorkspaceProviderGroupToJSON(json) {
    return GoogleWorkspaceProviderGroupToJSONTyped(json, false);
}
function GoogleWorkspaceProviderGroupToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=GoogleWorkspaceProviderGroup.js.map