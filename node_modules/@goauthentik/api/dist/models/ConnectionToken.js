...
exports.ConnectionTokenToJSONTyped = ConnectionTokenToJSONTyped;
...
function instanceOfConnectionToken(value) {
    ...
    if (!('endpoint' in value) || value['endpoint'] === undefined)
        return false;
    if (!('endpointObj' in value) || value['endpointObj'] === undefined)
        return false;
...
function ConnectionTokenToJSON(json) {
    return ConnectionTokenToJSONTyped(json, false);
}
function ConnectionTokenToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
