...
exports.PaginatedKerberosSourceListToJSONTyped = PaginatedKerberosSourceListToJSONTyped;
...
function PaginatedKerberosSourceListToJSON(json) {
    return PaginatedKerberosSourceListToJSONTyped(json, false);
}
function PaginatedKerberosSourceListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PaginatedKerberosSourceList.js.map