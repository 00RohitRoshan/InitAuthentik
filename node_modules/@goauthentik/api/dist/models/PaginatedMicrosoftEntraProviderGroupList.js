...
exports.PaginatedMicrosoftEntraProviderGroupListToJSONTyped = PaginatedMicrosoftEntraProviderGroupListToJSONTyped;
...
function PaginatedMicrosoftEntraProviderGroupListToJSON(json) {
    return PaginatedMicrosoftEntraProviderGroupListToJSONTyped(json, false);
}
function PaginatedMicrosoftEntraProviderGroupListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PaginatedMicrosoftEntraProviderGroupList.js.map