...
exports.MicrosoftEntraProviderMappingRequestToJSONTyped = MicrosoftEntraProviderMappingRequestToJSONTyped;
/**
...
function MicrosoftEntraProviderMappingRequestToJSON(json) {
    return MicrosoftEntraProviderMappingRequestToJSONTyped(json, false);
}
function MicrosoftEntraProviderMappingRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=MicrosoftEntraProviderMappingRequest.js.map