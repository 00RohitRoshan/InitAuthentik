...
exports.ConsentChallengeToJSONTyped = ConsentChallengeToJSONTyped;
...
function ConsentChallengeToJSON(json) {
    return ConsentChallengeToJSONTyped(json, false);
}
function ConsentChallengeToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=ConsentChallenge.js.map