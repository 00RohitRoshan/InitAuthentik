...
exports.CertificateKeyPairRequestToJSONTyped = CertificateKeyPairRequestToJSONTyped;
/**
...
function instanceOfCertificateKeyPairRequest(value) {
    if (!('name' in value) || value['name'] === undefined)
        return false;
    if (!('certificateData' in value) || value['certificateData'] === undefined)
        return false;
    return true;
}
...
function CertificateKeyPairRequestToJSON(json) {
    return CertificateKeyPairRequestToJSONTyped(json, false);
}
function CertificateKeyPairRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=CertificateKeyPairRequest.js.map