...
exports.instanceOfSCIMMapping = instanceOfSCIMMapping;
exports.SCIMMappingFromJSON = SCIMMappingFromJSON;
exports.SCIMMappingFromJSONTyped = SCIMMappingFromJSONTyped;
exports.SCIMMappingToJSON = SCIMMappingToJSON;
exports.SCIMMappingToJSONTyped = SCIMMappingToJSONTyped;
/**
 * Check if a given object implements the SCIMMapping interface.
 */
function instanceOfSCIMMapping(value) {
...
function SCIMMappingFromJSON(json) {
    return SCIMMappingFromJSONTyped(json, false);
}
function SCIMMappingFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function SCIMMappingToJSON(json) {
    return SCIMMappingToJSONTyped(json, false);
}
function SCIMMappingToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=SCIMMapping.js.map