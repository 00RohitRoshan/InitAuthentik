...
exports.PropertyMappingTestRequestToJSONTyped = PropertyMappingTestRequestToJSONTyped;
/**
...
function PropertyMappingTestRequestToJSON(json) {
    return PropertyMappingTestRequestToJSONTyped(json, false);
}
function PropertyMappingTestRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PropertyMappingTestRequest.js.map