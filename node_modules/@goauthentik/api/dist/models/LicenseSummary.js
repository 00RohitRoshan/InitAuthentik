...
exports.LicenseSummaryFromJSON = LicenseSummaryFromJSON;
exports.LicenseSummaryFromJSONTyped = LicenseSummaryFromJSONTyped;
exports.LicenseSummaryToJSON = LicenseSummaryToJSON;
exports.LicenseSummaryToJSONTyped = LicenseSummaryToJSONTyped;
 ...
 */
function instanceOfLicenseSummary(value) {
    ...
    if (!('status' in value) || value['status'] === undefined)
        return false;
    if (!('latestValid' in value) || value['latestValid'] === undefined)
        return false;
    if (!('licenseFlags' in value) || value['licenseFlags'] === undefined)
        return false;
    return true;
}
function LicenseSummaryFromJSON(json) {
    return LicenseSummaryFromJSONTyped(json, false);
}
function LicenseSummaryFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function LicenseSummaryToJSON(json) {
    return LicenseSummaryToJSONTyped(json, false);
}
function LicenseSummaryToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=LicenseSummary.js.map