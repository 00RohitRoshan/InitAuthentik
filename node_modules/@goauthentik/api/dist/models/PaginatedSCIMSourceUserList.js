...
exports.PaginatedSCIMSourceUserListToJSONTyped = PaginatedSCIMSourceUserListToJSONTyped;
...
function PaginatedSCIMSourceUserListToJSON(json) {
    return PaginatedSCIMSourceUserListToJSONTyped(json, false);
}
function PaginatedSCIMSourceUserListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PaginatedSCIMSourceUserList.js.map