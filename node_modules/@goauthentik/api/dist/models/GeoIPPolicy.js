...
exports.GeoIPPolicyToJSONTyped = GeoIPPolicyToJSONTyped;
...
function instanceOfGeoIPPolicy(value) {
    ...
    if (!('countries' in value) || value['countries'] === undefined)
        return false;
    if (!('countriesObj' in value) || value['countriesObj'] === undefined)
        return false;
    return true;
}
...
function GeoIPPolicyToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=GeoIPPolicy.js.map