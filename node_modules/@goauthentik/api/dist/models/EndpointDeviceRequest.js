...
exports.EndpointDeviceRequestToJSONTyped = EndpointDeviceRequestToJSONTyped;
/**
...
function EndpointDeviceRequestToJSON(json) {
    return EndpointDeviceRequestToJSONTyped(json, false);
}
function EndpointDeviceRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=EndpointDeviceRequest.js.map