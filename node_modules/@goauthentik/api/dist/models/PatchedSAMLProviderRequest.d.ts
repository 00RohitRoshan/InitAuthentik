 ...
 */
export declare function instanceOfPatchedSAMLProviderRequest(value: object): value is PatchedSAMLProviderRequest;
export declare function PatchedSAMLProviderRequestFromJSON(json: any): PatchedSAMLProviderRequest;
export declare function PatchedSAMLProviderRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PatchedSAMLProviderRequest;
export declare function PatchedSAMLProviderRequestToJSON(json: any): PatchedSAMLProviderRequest;
export declare function PatchedSAMLProviderRequestToJSONTyped(value?: PatchedSAMLProviderRequest | null, ignoreDiscriminator?: boolean): any;
//# sourceMappingURL=PatchedSAMLProviderRequest.d.ts.map