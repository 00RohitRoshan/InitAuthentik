...
exports.PaginatedKerberosSourcePropertyMappingListToJSONTyped = PaginatedKerberosSourcePropertyMappingListToJSONTyped;
...
function PaginatedKerberosSourcePropertyMappingListToJSON(json) {
    return PaginatedKerberosSourcePropertyMappingListToJSONTyped(json, false);
}
function PaginatedKerberosSourcePropertyMappingListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PaginatedKerberosSourcePropertyMappingList.js.map