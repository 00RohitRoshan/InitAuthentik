...
exports.RACPropertyMappingRequestToJSONTyped = RACPropertyMappingRequestToJSONTyped;
/**
...
function RACPropertyMappingRequestToJSON(json) {
    return RACPropertyMappingRequestToJSONTyped(json, false);
}
function RACPropertyMappingRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=RACPropertyMappingRequest.js.map