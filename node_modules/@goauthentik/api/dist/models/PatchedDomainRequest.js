...
exports.PatchedDomainRequestToJSONTyped = PatchedDomainRequestToJSONTyped;
/**
...
function PatchedDomainRequestToJSON(json) {
    return PatchedDomainRequestToJSONTyped(json, false);
}
function PatchedDomainRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PatchedDomainRequest.js.map