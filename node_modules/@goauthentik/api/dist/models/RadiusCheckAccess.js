...
exports.RadiusCheckAccessToJSONTyped = RadiusCheckAccessToJSONTyped;
...
function RadiusCheckAccessToJSON(json) {
    return RadiusCheckAccessToJSONTyped(json, false);
}
function RadiusCheckAccessToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=RadiusCheckAccess.js.map