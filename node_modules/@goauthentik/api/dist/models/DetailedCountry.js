...
exports.DetailedCountryToJSONTyped = DetailedCountryToJSONTyped;
...
function DetailedCountryToJSON(json) {
    return DetailedCountryToJSONTyped(json, false);
}
function DetailedCountryToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=DetailedCountry.js.map