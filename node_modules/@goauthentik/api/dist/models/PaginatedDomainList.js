...
exports.PaginatedDomainListToJSONTyped = PaginatedDomainListToJSONTyped;
...
function PaginatedDomainListToJSON(json) {
    return PaginatedDomainListToJSONTyped(json, false);
}
function PaginatedDomainListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PaginatedDomainList.js.map