...
exports.FrameChallengeToJSONTyped = FrameChallengeToJSONTyped;
...
function instanceOfFrameChallenge(value) {
    if (!('url' in value) || value['url'] === undefined)
        return false;
    if (!('loadingText' in value) || value['loadingText'] === undefined)
        return false;
    return true;
}
...
function FrameChallengeToJSON(json) {
    return FrameChallengeToJSONTyped(json, false);
}
function FrameChallengeToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=FrameChallenge.js.map