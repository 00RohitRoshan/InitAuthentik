...
exports.TransactionApplicationRequestToJSONTyped = TransactionApplicationRequestToJSONTyped;
...
function instanceOfTransactionApplicationRequest(value) {
    if (!('app' in value) || value['app'] === undefined)
        return false;
    if (!('providerModel' in value) || value['providerModel'] === undefined)
        return false;
...
function TransactionApplicationRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'policyBindings': json['policy_bindings'] == null ? undefined : (json['policy_bindings'].map(TransactionPolicyBindingRequest_1.TransactionPolicyBindingRequestFromJSON)),
    };
}
function TransactionApplicationRequestToJSON(json) {
    return TransactionApplicationRequestToJSONTyped(json, false);
}
function TransactionApplicationRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
        ...
        'policy_bindings': value['policyBindings'] == null ? undefined : (value['policyBindings'].map(TransactionPolicyBindingRequest_1.TransactionPolicyBindingRequestToJSON)),
    };
}
//# sourceMappingURL=TransactionApplicationRequest.js.map