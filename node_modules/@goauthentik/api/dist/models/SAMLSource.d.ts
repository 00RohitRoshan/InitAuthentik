 ...
 */
export declare function instanceOfSAMLSource(value: object): value is SAMLSource;
...
export declare function SAMLSourceToJSON(json: any): SAMLSource;
export declare function SAMLSourceToJSONTyped(value?: Omit<SAMLSource, 'pk' | 'component' | 'verbose_name' | 'verbose_name_plural' | 'meta_model_name' | 'managed' | 'icon'> | null, ignoreDiscriminator?: boolean): any;
//# sourceMappingURL=SAMLSource.d.ts.map