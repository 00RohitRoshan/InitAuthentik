 ...
 */
export declare function instanceOfAuthenticatorWebAuthnStage(value: object): value is AuthenticatorWebAuthnStage;
...
export declare function AuthenticatorWebAuthnStageToJSON(json: any): AuthenticatorWebAuthnStage;
export declare function AuthenticatorWebAuthnStageToJSONTyped(value?: Omit<AuthenticatorWebAuthnStage, 'pk' | 'component' | 'verbose_name' | 'verbose_name_plural' | 'meta_model_name' | 'device_type_restrictions_obj'> | null, ignoreDiscriminator?: boolean): any;
//# sourceMappingURL=AuthenticatorWebAuthnStage.d.ts.map