...
exports.PaginatedGoogleWorkspaceProviderGroupListToJSONTyped = PaginatedGoogleWorkspaceProviderGroupListToJSONTyped;
...
function PaginatedGoogleWorkspaceProviderGroupListToJSON(json) {
    return PaginatedGoogleWorkspaceProviderGroupListToJSONTyped(json, false);
}
function PaginatedGoogleWorkspaceProviderGroupListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PaginatedGoogleWorkspaceProviderGroupList.js.map