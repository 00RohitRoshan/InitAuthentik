...
exports.DetailedCountryFieldToJSONTyped = DetailedCountryFieldToJSONTyped;
...
function DetailedCountryFieldToJSON(json) {
    return DetailedCountryFieldToJSONTyped(json, false);
}
function DetailedCountryFieldToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=DetailedCountryField.js.map