...
exports.PatchedUserPlexSourceConnectionRequestToJSONTyped = PatchedUserPlexSourceConnectionRequestToJSONTyped;
/**
...
function PatchedUserPlexSourceConnectionRequestToJSON(json) {
    return PatchedUserPlexSourceConnectionRequestToJSONTyped(json, false);
}
function PatchedUserPlexSourceConnectionRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PatchedUserPlexSourceConnectionRequest.js.map