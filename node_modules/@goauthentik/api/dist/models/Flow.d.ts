...
export declare function FlowToJSONTyped(value?: Omit<Flow, 'pk' | 'policybindingmodel_ptr_id' | 'background' | 'stages' | 'policies' | 'cache_count' | 'export_url'> | null, ignoreDiscriminator?: boolean): any;
