...
exports.SystemTaskToJSONTyped = SystemTaskToJSONTyped;
...
function instanceOfSystemTask(value) {
    ...
    if (!('description' in value) || value['description'] === undefined)
        return false;
    if (!('startTimestamp' in value) || value['startTimestamp'] === undefined)
        return false;
    if (!('finishTimestamp' in value) || value['finishTimestamp'] === undefined)
        return false;
...
function SystemTaskToJSON(json) {
    return SystemTaskToJSONTyped(json, false);
}
function SystemTaskToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=SystemTask.js.map