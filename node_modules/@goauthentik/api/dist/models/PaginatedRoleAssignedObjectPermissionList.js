...
exports.PaginatedRoleAssignedObjectPermissionListToJSONTyped = PaginatedRoleAssignedObjectPermissionListToJSONTyped;
...
function PaginatedRoleAssignedObjectPermissionListToJSON(json) {
    return PaginatedRoleAssignedObjectPermissionListToJSONTyped(json, false);
}
function PaginatedRoleAssignedObjectPermissionListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PaginatedRoleAssignedObjectPermissionList.js.map