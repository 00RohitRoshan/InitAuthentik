...
exports.PaginatedSCIMSourceListToJSONTyped = PaginatedSCIMSourceListToJSONTyped;
...
function PaginatedSCIMSourceListToJSON(json) {
    return PaginatedSCIMSourceListToJSONTyped(json, false);
}
function PaginatedSCIMSourceListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PaginatedSCIMSourceList.js.map