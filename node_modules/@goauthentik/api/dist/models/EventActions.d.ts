...
export declare function instanceOfEventActions(value: any): boolean;
...
export declare function EventActionsToJSONTyped(value: any, ignoreDiscriminator: boolean): EventActions;
