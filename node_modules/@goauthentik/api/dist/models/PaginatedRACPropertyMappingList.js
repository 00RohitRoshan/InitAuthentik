...
exports.PaginatedRACPropertyMappingListToJSONTyped = PaginatedRACPropertyMappingListToJSONTyped;
...
function PaginatedRACPropertyMappingListToJSON(json) {
    return PaginatedRACPropertyMappingListToJSONTyped(json, false);
}
function PaginatedRACPropertyMappingListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PaginatedRACPropertyMappingList.js.map