...
exports.instanceOfSelectableStage = instanceOfSelectableStage;
...
exports.SelectableStageToJSONTyped = SelectableStageToJSONTyped;
/**
 * Check if a given object implements the SelectableStage interface.
 */
function instanceOfSelectableStage(value) {
...
function SelectableStageToJSON(json) {
    return SelectableStageToJSONTyped(json, false);
}
function SelectableStageToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=SelectableStage.js.map