...
exports.instanceOfFlowErrorChallenge = instanceOfFlowErrorChallenge;
...
function FlowErrorChallengeToJSON(json) {
    return FlowErrorChallengeToJSONTyped(json, false);
}
function FlowErrorChallengeToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=FlowErrorChallenge.js.map