...
exports.PaginatedRACProviderListToJSONTyped = PaginatedRACProviderListToJSONTyped;
...
function PaginatedRACProviderListToJSON(json) {
    return PaginatedRACProviderListToJSONTyped(json, false);
}
function PaginatedRACProviderListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PaginatedRACProviderList.js.map