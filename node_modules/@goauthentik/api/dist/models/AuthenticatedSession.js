...
exports.AuthenticatedSessionToJSONTyped = AuthenticatedSessionToJSONTyped;
...
function instanceOfAuthenticatedSession(value) {
    ...
    if (!('userAgent' in value) || value['userAgent'] === undefined)
        return false;
    if (!('geoIp' in value) || value['geoIp'] === undefined)
        return false;
...
function AuthenticatedSessionToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=AuthenticatedSession.js.map