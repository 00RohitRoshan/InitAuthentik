...
exports.OpenIDConnectConfigurationToJSONTyped = OpenIDConnectConfigurationToJSONTyped;
/**
...
function instanceOfOpenIDConnectConfiguration(value) {
    ...
    if (!('tokenEndpoint' in value) || value['tokenEndpoint'] === undefined)
        return false;
    if (!('userinfoEndpoint' in value) || value['userinfoEndpoint'] === undefined)
        return false;
    if (!('endSessionEndpoint' in value) || value['endSessionEndpoint'] === undefined)
        return false;
    if (!('introspectionEndpoint' in value) || value['introspectionEndpoint'] === undefined)
        return false;
    if (!('jwksUri' in value) || value['jwksUri'] === undefined)
        return false;
    if (!('responseTypesSupported' in value) || value['responseTypesSupported'] === undefined)
        return false;
    if (!('idTokenSigningAlgValuesSupported' in value) || value['idTokenSigningAlgValuesSupported'] === undefined)
        return false;
    if (!('subjectTypesSupported' in value) || value['subjectTypesSupported'] === undefined)
        return false;
    if (!('tokenEndpointAuthMethodsSupported' in value) || value['tokenEndpointAuthMethodsSupported'] === undefined)
        return false;
    return true;
}
...
function OpenIDConnectConfigurationToJSON(json) {
    return OpenIDConnectConfigurationToJSONTyped(json, false);
}
function OpenIDConnectConfigurationToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=OpenIDConnectConfiguration.js.map