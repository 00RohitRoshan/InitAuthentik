...
function instanceOfStagePrompt(value) {
    ...
    if (!('placeholder' in value) || value['placeholder'] === undefined)
        return false;
    if (!('initialValue' in value) || value['initialValue'] === undefined)
        return false;
...
function StagePromptFromJSON(json) {
    return StagePromptFromJSONTyped(json, false);
}
function StagePromptFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function StagePromptToJSON(json) {
    return StagePromptToJSONTyped(json, false);
}
function StagePromptToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
