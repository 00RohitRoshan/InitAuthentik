...
exports.RoleAssignedObjectPermissionToJSONTyped = RoleAssignedObjectPermissionToJSONTyped;
...
function instanceOfRoleAssignedObjectPermission(value) {
    if (!('rolePk' in value) || value['rolePk'] === undefined)
        return false;
...
function RoleAssignedObjectPermissionToJSON(json) {
    return RoleAssignedObjectPermissionToJSONTyped(json, false);
}
function RoleAssignedObjectPermissionToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=RoleAssignedObjectPermission.js.map