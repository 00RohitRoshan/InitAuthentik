...
exports.GoogleWorkspaceProviderMappingRequestToJSONTyped = GoogleWorkspaceProviderMappingRequestToJSONTyped;
/**
...
function GoogleWorkspaceProviderMappingRequestToJSON(json) {
    return GoogleWorkspaceProviderMappingRequestToJSONTyped(json, false);
}
function GoogleWorkspaceProviderMappingRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=GoogleWorkspaceProviderMappingRequest.js.map