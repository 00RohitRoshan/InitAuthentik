...
exports.RedirectURIRequestToJSONTyped = RedirectURIRequestToJSONTyped;
...
function instanceOfRedirectURIRequest(value) {
    if (!('matchingMode' in value) || value['matchingMode'] === undefined)
        return false;
...
function RedirectURIRequestToJSON(json) {
    return RedirectURIRequestToJSONTyped(json, false);
}
function RedirectURIRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=RedirectURIRequest.js.map