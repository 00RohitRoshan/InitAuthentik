...
exports.instanceOfUserSelfGroups = instanceOfUserSelfGroups;
...
exports.UserSelfGroupsToJSONTyped = UserSelfGroupsToJSONTyped;
/**
 * Check if a given object implements the UserSelfGroups interface.
 */
function instanceOfUserSelfGroups(value) {
...
function UserSelfGroupsToJSON(json) {
    return UserSelfGroupsToJSONTyped(json, false);
}
function UserSelfGroupsToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {};
}
//# sourceMappingURL=UserSelfGroups.js.map