 ...
 */
export declare function instanceOfGeoIPPolicy(value: object): value is GeoIPPolicy;
...
export declare function GeoIPPolicyToJSON(json: any): GeoIPPolicy;
export declare function GeoIPPolicyToJSONTyped(value?: Omit<GeoIPPolicy, 'pk' | 'component' | 'verbose_name' | 'verbose_name_plural' | 'meta_model_name' | 'bound_to' | 'countries_obj'> | null, ignoreDiscriminator?: boolean): any;
//# sourceMappingURL=GeoIPPolicy.d.ts.map