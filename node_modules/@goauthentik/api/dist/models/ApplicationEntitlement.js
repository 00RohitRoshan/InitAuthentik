...
exports.ApplicationEntitlementToJSONTyped = ApplicationEntitlementToJSONTyped;
/**
 * Check if a given object implements the ApplicationEntitlement interface.
 */
function instanceOfApplicationEntitlement(value) {
    if (!('pbmUuid' in value) || value['pbmUuid'] === undefined)
        return false;
...
function ApplicationEntitlementToJSON(json) {
    return ApplicationEntitlementToJSONTyped(json, false);
}
function ApplicationEntitlementToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
