...
exports.PaginatedSCIMProviderGroupListToJSONTyped = PaginatedSCIMProviderGroupListToJSONTyped;
...
function PaginatedSCIMProviderGroupListToJSON(json) {
    return PaginatedSCIMProviderGroupListToJSONTyped(json, false);
}
function PaginatedSCIMProviderGroupListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PaginatedSCIMProviderGroupList.js.map