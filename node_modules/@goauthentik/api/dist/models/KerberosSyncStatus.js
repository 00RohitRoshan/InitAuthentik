...
exports.KerberosSyncStatusToJSONTyped = KerberosSyncStatusToJSONTyped;
...
function KerberosSyncStatusToJSON(json) {
    return KerberosSyncStatusToJSONTyped(json, false);
}
function KerberosSyncStatusToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {};
}
//# sourceMappingURL=KerberosSyncStatus.js.map