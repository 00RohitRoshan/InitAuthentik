...
exports.PaginatedEndpointDeviceListToJSONTyped = PaginatedEndpointDeviceListToJSONTyped;
...
function PaginatedEndpointDeviceListToJSON(json) {
    return PaginatedEndpointDeviceListToJSONTyped(json, false);
}
function PaginatedEndpointDeviceListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PaginatedEndpointDeviceList.js.map