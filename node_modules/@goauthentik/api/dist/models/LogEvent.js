...
exports.LogEventToJSONTyped = LogEventToJSONTyped;
...
function instanceOfLogEvent(value) {
    if (!('timestamp' in value) || value['timestamp'] === undefined)
        return false;
    if (!('logLevel' in value) || value['logLevel'] === undefined)
        return false;
    if (!('logger' in value) || value['logger'] === undefined)
        return false;
...
function LogEventToJSON(json) {
    return LogEventToJSONTyped(json, false);
}
function LogEventToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
