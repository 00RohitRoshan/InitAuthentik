...
exports.PaginatedGroupOAuthSourceConnectionListToJSONTyped = PaginatedGroupOAuthSourceConnectionListToJSONTyped;
...
function PaginatedGroupOAuthSourceConnectionListToJSON(json) {
    return PaginatedGroupOAuthSourceConnectionListToJSONTyped(json, false);
}
function PaginatedGroupOAuthSourceConnectionListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PaginatedGroupOAuthSourceConnectionList.js.map