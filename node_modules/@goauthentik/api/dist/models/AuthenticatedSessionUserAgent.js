...
exports.AuthenticatedSessionUserAgentToJSONTyped = AuthenticatedSessionUserAgentToJSONTyped;
...
function AuthenticatedSessionUserAgentToJSON(json) {
    return AuthenticatedSessionUserAgentToJSONTyped(json, false);
}
function AuthenticatedSessionUserAgentToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=AuthenticatedSessionUserAgent.js.map