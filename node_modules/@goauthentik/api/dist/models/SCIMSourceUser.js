...
exports.SCIMSourceUserToJSONTyped = SCIMSourceUserToJSONTyped;
...
function SCIMSourceUserToJSON(json) {
    return SCIMSourceUserToJSONTyped(json, false);
}
function SCIMSourceUserToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=SCIMSourceUser.js.map