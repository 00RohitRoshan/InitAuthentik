...
function CaptchaStageFromJSON(json) {
    return CaptchaStageFromJSONTyped(json, false);
}
function CaptchaStageFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function CaptchaStageToJSON(json) {
    return CaptchaStageToJSONTyped(json, false);
}
function CaptchaStageToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=CaptchaStage.js.map