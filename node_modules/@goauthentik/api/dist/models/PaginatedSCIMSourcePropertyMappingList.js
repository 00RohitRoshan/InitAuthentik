...
exports.PaginatedSCIMSourcePropertyMappingListToJSONTyped = PaginatedSCIMSourcePropertyMappingListToJSONTyped;
...
function PaginatedSCIMSourcePropertyMappingListToJSON(json) {
    return PaginatedSCIMSourcePropertyMappingListToJSONTyped(json, false);
}
function PaginatedSCIMSourcePropertyMappingListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PaginatedSCIMSourcePropertyMappingList.js.map