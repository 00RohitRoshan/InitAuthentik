...
exports.PaginatedSourceStageListToJSONTyped = PaginatedSourceStageListToJSONTyped;
...
function PaginatedSourceStageListToJSON(json) {
    return PaginatedSourceStageListToJSONTyped(json, false);
}
function PaginatedSourceStageListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PaginatedSourceStageList.js.map