...
exports.SyncObjectResultToJSONTyped = SyncObjectResultToJSONTyped;
...
function SyncObjectResultToJSON(json) {
    return SyncObjectResultToJSONTyped(json, false);
}
function SyncObjectResultToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {};
}
//# sourceMappingURL=SyncObjectResult.js.map