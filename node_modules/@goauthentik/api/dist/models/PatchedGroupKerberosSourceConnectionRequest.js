...
exports.PatchedGroupKerberosSourceConnectionRequestToJSONTyped = PatchedGroupKerberosSourceConnectionRequestToJSONTyped;
/**
...
function PatchedGroupKerberosSourceConnectionRequestToJSON(json) {
    return PatchedGroupKerberosSourceConnectionRequestToJSONTyped(json, false);
}
function PatchedGroupKerberosSourceConnectionRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PatchedGroupKerberosSourceConnectionRequest.js.map