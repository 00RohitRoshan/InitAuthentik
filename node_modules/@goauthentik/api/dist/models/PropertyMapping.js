...
exports.instanceOfPropertyMapping = instanceOfPropertyMapping;
exports.PropertyMappingFromJSON = PropertyMappingFromJSON;
exports.PropertyMappingFromJSONTyped = PropertyMappingFromJSONTyped;
exports.PropertyMappingToJSON = PropertyMappingToJSON;
exports.PropertyMappingToJSONTyped = PropertyMappingToJSONTyped;
/**
 * Check if a given object implements the PropertyMapping interface.
 */
function instanceOfPropertyMapping(value) {
...
function PropertyMappingFromJSON(json) {
    return PropertyMappingFromJSONTyped(json, false);
}
function PropertyMappingFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PropertyMappingToJSON(json) {
    return PropertyMappingToJSONTyped(json, false);
}
function PropertyMappingToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
