...
exports.ImpersonationRequestToJSONTyped = ImpersonationRequestToJSONTyped;
/**
...
function ImpersonationRequestToJSON(json) {
    return ImpersonationRequestToJSONTyped(json, false);
}
function ImpersonationRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=ImpersonationRequest.js.map