...
export declare class EventsApi extends runtime.BaseAPI {
     ...
     */
    eventsEventsVolumeListRaw(requestParameters: EventsEventsVolumeListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<EventVolume>>>;
    /**
     * Get event volume for specified filters and timeframe
     */
    eventsEventsVolumeList(requestParameters?: EventsEventsVolumeListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<EventVolume>>;
    /**
 ...
 * @export
 */
export declare const EventsEventsListActionsEnum: {
 ...
 * @export
 */
export declare const EventsEventsVolumeListActionsEnum: {
    readonly AuthorizeApplication: "authorize_application";
    readonly ConfigurationError: "configuration_error";
    readonly Custom: "custom_";
    readonly EmailSent: "email_sent";
