 ...
 */
export declare function instanceOfOAuth2Provider(value: object): value is OAuth2Provider;
...
export declare function OAuth2ProviderToJSON(json: any): OAuth2Provider;
export declare function OAuth2ProviderToJSONTyped(value?: Omit<OAuth2Provider, 'pk' | 'component' | 'assigned_application_slug' | 'assigned_application_name' | 'assigned_backchannel_application_slug' | 'assigned_backchannel_application_name' | 'verbose_name' | 'verbose_name_plural' | 'meta_model_name'> | null, ignoreDiscriminator?: boolean): any;
//# sourceMappingURL=OAuth2Provider.d.ts.map