...
exports.PermissionAssignRequestToJSONTyped = PermissionAssignRequestToJSONTyped;
...
function PermissionAssignRequestToJSON(json) {
    return PermissionAssignRequestToJSONTyped(json, false);
}
function PermissionAssignRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PermissionAssignRequest.js.map