...
exports.PaginatedEndpointListToJSONTyped = PaginatedEndpointListToJSONTyped;
...
function PaginatedEndpointListToJSON(json) {
    return PaginatedEndpointListToJSONTyped(json, false);
}
function PaginatedEndpointListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PaginatedEndpointList.js.map