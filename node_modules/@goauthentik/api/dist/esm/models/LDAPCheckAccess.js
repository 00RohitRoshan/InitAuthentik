...
exports.LDAPCheckAccessToJSONTyped = LDAPCheckAccessToJSONTyped;
...
function LDAPCheckAccessToJSON(json) {
    return LDAPCheckAccessToJSONTyped(json, false);
}
function LDAPCheckAccessToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=LDAPCheckAccess.js.map