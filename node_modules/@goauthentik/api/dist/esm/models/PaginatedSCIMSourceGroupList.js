...
exports.PaginatedSCIMSourceGroupListToJSONTyped = PaginatedSCIMSourceGroupListToJSONTyped;
...
function PaginatedSCIMSourceGroupListToJSON(json) {
    return PaginatedSCIMSourceGroupListToJSONTyped(json, false);
}
function PaginatedSCIMSourceGroupListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PaginatedSCIMSourceGroupList.js.map