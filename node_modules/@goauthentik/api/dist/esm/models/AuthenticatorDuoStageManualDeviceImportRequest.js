...
exports.instanceOfAuthenticatorDuoStageManualDeviceImportRequest = instanceOfAuthenticatorDuoStageManualDeviceImportRequest;
...
exports.AuthenticatorDuoStageManualDeviceImportRequestToJSONTyped = AuthenticatorDuoStageManualDeviceImportRequestToJSONTyped;
/**
 * Check if a given object implements the AuthenticatorDuoStageManualDeviceImportRequest interface.
 */
function instanceOfAuthenticatorDuoStageManualDeviceImportRequest(value) {
    if (!('duoUserId' in value) || value['duoUserId'] === undefined)
        return false;
...
function AuthenticatorDuoStageManualDeviceImportRequestToJSON(json) {
    return AuthenticatorDuoStageManualDeviceImportRequestToJSONTyped(json, false);
}
function AuthenticatorDuoStageManualDeviceImportRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=AuthenticatorDuoStageManualDeviceImportRequest.js.map