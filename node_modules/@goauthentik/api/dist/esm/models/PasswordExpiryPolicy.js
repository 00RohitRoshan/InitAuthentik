...
exports.instanceOfPasswordExpiryPolicy = instanceOfPasswordExpiryPolicy;
exports.PasswordExpiryPolicyFromJSON = PasswordExpiryPolicyFromJSON;
exports.PasswordExpiryPolicyFromJSONTyped = PasswordExpiryPolicyFromJSONTyped;
exports.PasswordExpiryPolicyToJSON = PasswordExpiryPolicyToJSON;
exports.PasswordExpiryPolicyToJSONTyped = PasswordExpiryPolicyToJSONTyped;
/**
 * Check if a given object implements the PasswordExpiryPolicy interface.
 */
function instanceOfPasswordExpiryPolicy(value) {
...
function PasswordExpiryPolicyFromJSON(json) {
    return PasswordExpiryPolicyFromJSONTyped(json, false);
}
function PasswordExpiryPolicyFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PasswordExpiryPolicyToJSON(json) {
    return PasswordExpiryPolicyToJSONTyped(json, false);
}
function PasswordExpiryPolicyToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PasswordExpiryPolicy.js.map