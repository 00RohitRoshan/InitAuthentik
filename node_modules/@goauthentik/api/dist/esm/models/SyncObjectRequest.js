...
exports.SyncObjectRequestToJSONTyped = SyncObjectRequestToJSONTyped;
...
function instanceOfSyncObjectRequest(value) {
    if (!('syncObjectModel' in value) || value['syncObjectModel'] === undefined)
        return false;
    if (!('syncObjectId' in value) || value['syncObjectId'] === undefined)
        return false;
    return true;
}
...
function SyncObjectRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=SyncObjectRequest.js.map