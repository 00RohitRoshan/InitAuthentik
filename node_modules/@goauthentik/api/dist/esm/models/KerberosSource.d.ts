 ...
 */
export declare function instanceOfKerberosSource(value: object): value is KerberosSource;
...
export declare function KerberosSourceToJSON(json: any): KerberosSource;
export declare function KerberosSourceToJSONTyped(value?: Omit<KerberosSource, 'pk' | 'component' | 'verbose_name' | 'verbose_name_plural' | 'meta_model_name' | 'managed' | 'icon' | 'connectivity'> | null, ignoreDiscriminator?: boolean): any;
//# sourceMappingURL=KerberosSource.d.ts.map