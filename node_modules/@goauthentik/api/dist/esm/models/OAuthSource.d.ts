 ...
 */
export declare function instanceOfOAuthSource(value: object): value is OAuthSource;
...
export declare function OAuthSourceToJSON(json: any): OAuthSource;
export declare function OAuthSourceToJSONTyped(value?: Omit<OAuthSource, 'pk' | 'component' | 'verbose_name' | 'verbose_name_plural' | 'meta_model_name' | 'managed' | 'icon' | 'callback_url' | 'type'> | null, ignoreDiscriminator?: boolean): any;
//# sourceMappingURL=OAuthSource.d.ts.map