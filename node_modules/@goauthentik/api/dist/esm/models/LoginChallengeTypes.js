...
exports.LoginChallengeTypesToJSONTyped = LoginChallengeTypesToJSONTyped;
...
function LoginChallengeTypesToJSON(json) {
    return LoginChallengeTypesToJSONTyped(json, false);
}
function LoginChallengeTypesToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
...
//# sourceMappingURL=LoginChallengeTypes.js.map