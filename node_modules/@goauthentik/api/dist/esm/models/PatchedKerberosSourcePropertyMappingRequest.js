...
exports.PatchedKerberosSourcePropertyMappingRequestToJSONTyped = PatchedKerberosSourcePropertyMappingRequestToJSONTyped;
/**
...
function PatchedKerberosSourcePropertyMappingRequestToJSON(json) {
    return PatchedKerberosSourcePropertyMappingRequestToJSONTyped(json, false);
}
function PatchedKerberosSourcePropertyMappingRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PatchedKerberosSourcePropertyMappingRequest.js.map