 ...
 */
export declare function instanceOfLDAPDebug(value: object): value is LDAPDebug;
...
export declare function LDAPDebugToJSON(json: any): LDAPDebug;
export declare function LDAPDebugToJSONTyped(value?: Omit<LDAPDebug, 'user' | 'group' | 'membership'> | null, ignoreDiscriminator?: boolean): any;
//# sourceMappingURL=LDAPDebug.d.ts.map