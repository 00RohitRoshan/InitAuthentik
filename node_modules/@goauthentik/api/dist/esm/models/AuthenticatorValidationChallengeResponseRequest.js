...
exports.AuthenticatorValidationChallengeResponseRequestToJSONTyped = AuthenticatorValidationChallengeResponseRequestToJSONTyped;
...
function AuthenticatorValidationChallengeResponseRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'selectedChallenge': json['selected_challenge'] == null ? undefined : (0, DeviceChallengeRequest_1.DeviceChallengeRequestFromJSON)(json['selected_challenge']),
...
function AuthenticatorValidationChallengeResponseRequestToJSON(json) {
    return AuthenticatorValidationChallengeResponseRequestToJSONTyped(json, false);
}
function AuthenticatorValidationChallengeResponseRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=AuthenticatorValidationChallengeResponseRequest.js.map