...
export declare function SourceToJSONTyped(value?: Omit<Source, 'pk' | 'component' | 'verbose_name' | 'verbose_name_plural' | 'meta_model_name' | 'managed' | 'icon'> | null, ignoreDiscriminator?: boolean): any;
