...
exports.AccessDeniedChallengeToJSONTyped = AccessDeniedChallengeToJSONTyped;
...
function AccessDeniedChallengeToJSON(json) {
    return AccessDeniedChallengeToJSONTyped(json, false);
}
function AccessDeniedChallengeToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=AccessDeniedChallenge.js.map