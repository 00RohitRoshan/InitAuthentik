...
exports.SCIMSourcePropertyMappingRequestToJSONTyped = SCIMSourcePropertyMappingRequestToJSONTyped;
/**
...
function SCIMSourcePropertyMappingRequestToJSON(json) {
    return SCIMSourcePropertyMappingRequestToJSONTyped(json, false);
}
function SCIMSourcePropertyMappingRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=SCIMSourcePropertyMappingRequest.js.map