...
exports.RadiusProviderRequestFromJSON = RadiusProviderRequestFromJSON;
...
exports.RadiusProviderRequestToJSONTyped = RadiusProviderRequestToJSONTyped;
/**
 * Check if a given object implements the RadiusProviderRequest interface.
 */
function instanceOfRadiusProviderRequest(value) {
...
function RadiusProviderRequestFromJSON(json) {
    return RadiusProviderRequestFromJSONTyped(json, false);
}
function RadiusProviderRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function RadiusProviderRequestToJSON(json) {
    return RadiusProviderRequestToJSONTyped(json, false);
}
function RadiusProviderRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=RadiusProviderRequest.js.map