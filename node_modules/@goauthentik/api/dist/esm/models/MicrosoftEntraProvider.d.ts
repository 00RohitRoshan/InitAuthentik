 ...
 */
export declare function instanceOfMicrosoftEntraProvider(value: object): value is MicrosoftEntraProvider;
...
export declare function MicrosoftEntraProviderToJSON(json: any): MicrosoftEntraProvider;
export declare function MicrosoftEntraProviderToJSONTyped(value?: Omit<MicrosoftEntraProvider, 'pk' | 'component' | 'assigned_backchannel_application_slug' | 'assigned_backchannel_application_name' | 'verbose_name' | 'verbose_name_plural' | 'meta_model_name'> | null, ignoreDiscriminator?: boolean): any;
//# sourceMappingURL=MicrosoftEntraProvider.d.ts.map