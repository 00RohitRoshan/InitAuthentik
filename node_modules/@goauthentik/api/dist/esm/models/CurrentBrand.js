...
exports.CurrentBrandToJSONTyped = CurrentBrandToJSONTyped;
...
function CurrentBrandToJSON(json) {
    return CurrentBrandToJSONTyped(json, false);
}
function CurrentBrandToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=CurrentBrand.js.map