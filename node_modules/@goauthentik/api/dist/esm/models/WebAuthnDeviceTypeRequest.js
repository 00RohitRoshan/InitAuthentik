...
exports.WebAuthnDeviceTypeRequestToJSONTyped = WebAuthnDeviceTypeRequestToJSONTyped;
/**
...
function WebAuthnDeviceTypeRequestToJSON(json) {
    return WebAuthnDeviceTypeRequestToJSONTyped(json, false);
}
function WebAuthnDeviceTypeRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=WebAuthnDeviceTypeRequest.js.map