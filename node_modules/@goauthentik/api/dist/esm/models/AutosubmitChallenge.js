...
exports.instanceOfAutosubmitChallenge = instanceOfAutosubmitChallenge;
exports.AutosubmitChallengeFromJSON = AutosubmitChallengeFromJSON;
...
exports.AutosubmitChallengeToJSONTyped = AutosubmitChallengeToJSONTyped;
...
function AutosubmitChallengeFromJSON(json) {
    return AutosubmitChallengeFromJSONTyped(json, false);
}
function AutosubmitChallengeFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function AutosubmitChallengeToJSON(json) {
    return AutosubmitChallengeToJSONTyped(json, false);
}
function AutosubmitChallengeToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=AutosubmitChallenge.js.map