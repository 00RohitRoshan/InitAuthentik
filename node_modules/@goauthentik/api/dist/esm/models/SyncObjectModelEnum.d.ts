...
export declare const SyncObjectModelEnum: {
    readonly AuthentikCoreModelsUser: "authentik.core.models.User";
    readonly AuthentikCoreModelsGroup: "authentik.core.models.Group";
    readonly UnknownDefaultOpenApi: "11184809";
};
export type SyncObjectModelEnum = typeof SyncObjectModelEnum[keyof typeof SyncObjectModelEnum];
export declare function instanceOfSyncObjectModelEnum(value: any): boolean;
...
export declare function SyncObjectModelEnumToJSONTyped(value: any, ignoreDiscriminator: boolean): SyncObjectModelEnum;
//# sourceMappingURL=SyncObjectModelEnum.d.ts.map