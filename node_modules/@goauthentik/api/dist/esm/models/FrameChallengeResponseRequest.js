...
exports.FrameChallengeResponseRequestToJSONTyped = FrameChallengeResponseRequestToJSONTyped;
/**
...
function FrameChallengeResponseRequestToJSON(json) {
    return FrameChallengeResponseRequestToJSONTyped(json, false);
}
function FrameChallengeResponseRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=FrameChallengeResponseRequest.js.map