...
exports.PaginatedApplicationEntitlementListToJSONTyped = PaginatedApplicationEntitlementListToJSONTyped;
...
function PaginatedApplicationEntitlementListToJSON(json) {
    return PaginatedApplicationEntitlementListToJSONTyped(json, false);
}
function PaginatedApplicationEntitlementListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PaginatedApplicationEntitlementList.js.map