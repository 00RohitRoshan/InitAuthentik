...
exports.RedirectStageToJSONTyped = RedirectStageToJSONTyped;
...
function RedirectStageToJSON(json) {
    return RedirectStageToJSONTyped(json, false);
}
function RedirectStageToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=RedirectStage.js.map