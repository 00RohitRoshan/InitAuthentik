...
exports.PatchedRoleRequestToJSONTyped = PatchedRoleRequestToJSONTyped;
/**
...
function PatchedRoleRequestToJSON(json) {
    return PatchedRoleRequestToJSONTyped(json, false);
}
function PatchedRoleRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PatchedRoleRequest.js.map