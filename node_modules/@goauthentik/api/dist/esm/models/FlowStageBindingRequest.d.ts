 ...
 */
export declare function instanceOfFlowStageBindingRequest(value: object): value is FlowStageBindingRequest;
export declare function FlowStageBindingRequestFromJSON(json: any): FlowStageBindingRequest;
export declare function FlowStageBindingRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): FlowStageBindingRequest;
export declare function FlowStageBindingRequestToJSON(json: any): FlowStageBindingRequest;
export declare function FlowStageBindingRequestToJSONTyped(value?: FlowStageBindingRequest | null, ignoreDiscriminator?: boolean): any;
//# sourceMappingURL=FlowStageBindingRequest.d.ts.map