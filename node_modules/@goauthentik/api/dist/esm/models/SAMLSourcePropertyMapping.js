...
exports.SAMLSourcePropertyMappingToJSONTyped = SAMLSourcePropertyMappingToJSONTyped;
/**
...
function SAMLSourcePropertyMappingToJSON(json) {
    return SAMLSourcePropertyMappingToJSONTyped(json, false);
}
function SAMLSourcePropertyMappingToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=SAMLSourcePropertyMapping.js.map