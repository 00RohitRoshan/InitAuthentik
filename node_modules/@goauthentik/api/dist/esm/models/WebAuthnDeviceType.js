...
exports.WebAuthnDeviceTypeToJSONTyped = WebAuthnDeviceTypeToJSONTyped;
/**
...
function WebAuthnDeviceTypeToJSON(json) {
    return WebAuthnDeviceTypeToJSONTyped(json, false);
}
function WebAuthnDeviceTypeToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=WebAuthnDeviceType.js.map