...
exports.SessionEndChallengeToJSONTyped = SessionEndChallengeToJSONTyped;
...
function SessionEndChallengeToJSON(json) {
    return SessionEndChallengeToJSONTyped(json, false);
}
function SessionEndChallengeToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=SessionEndChallenge.js.map