...
exports.instanceOfPasswordStageRequest = instanceOfPasswordStageRequest;
exports.PasswordStageRequestFromJSON = PasswordStageRequestFromJSON;
...
exports.PasswordStageRequestToJSONTyped = PasswordStageRequestToJSONTyped;
 ...
 */
function instanceOfPasswordStageRequest(value) {
...
function PasswordStageRequestFromJSON(json) {
    return PasswordStageRequestFromJSONTyped(json, false);
}
function PasswordStageRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PasswordStageRequestToJSON(json) {
    return PasswordStageRequestToJSONTyped(json, false);
}
function PasswordStageRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PasswordStageRequest.js.map