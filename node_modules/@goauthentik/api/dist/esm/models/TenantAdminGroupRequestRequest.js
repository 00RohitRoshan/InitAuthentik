...
exports.TenantAdminGroupRequestRequestToJSONTyped = TenantAdminGroupRequestRequestToJSONTyped;
/**
...
function TenantAdminGroupRequestRequestToJSON(json) {
    return TenantAdminGroupRequestRequestToJSONTyped(json, false);
}
function TenantAdminGroupRequestRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=TenantAdminGroupRequestRequest.js.map