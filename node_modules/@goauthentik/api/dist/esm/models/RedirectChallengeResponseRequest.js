...
exports.RedirectChallengeResponseRequestToJSONTyped = RedirectChallengeResponseRequestToJSONTyped;
/**
...
function RedirectChallengeResponseRequestToJSON(json) {
    return RedirectChallengeResponseRequestToJSONTyped(json, false);
}
function RedirectChallengeResponseRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=RedirectChallengeResponseRequest.js.map