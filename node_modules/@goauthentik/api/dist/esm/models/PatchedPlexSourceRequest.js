...
exports.instanceOfPatchedPlexSourceRequest = instanceOfPatchedPlexSourceRequest;
exports.PatchedPlexSourceRequestFromJSON = PatchedPlexSourceRequestFromJSON;
exports.PatchedPlexSourceRequestFromJSONTyped = PatchedPlexSourceRequestFromJSONTyped;
exports.PatchedPlexSourceRequestToJSON = PatchedPlexSourceRequestToJSON;
exports.PatchedPlexSourceRequestToJSONTyped = PatchedPlexSourceRequestToJSONTyped;
 ...
 */
function instanceOfPatchedPlexSourceRequest(value) {
    return true;
}
function PatchedPlexSourceRequestFromJSON(json) {
    return PatchedPlexSourceRequestFromJSONTyped(json, false);
}
function PatchedPlexSourceRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PatchedPlexSourceRequestToJSON(json) {
    return PatchedPlexSourceRequestToJSONTyped(json, false);
}
function PatchedPlexSourceRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PatchedPlexSourceRequest.js.map