...
exports.SAMLProviderToJSONTyped = SAMLProviderToJSONTyped;
...
function SAMLProviderToJSON(json) {
    return SAMLProviderToJSONTyped(json, false);
}
function SAMLProviderToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
