...
exports.PaginatedGeoIPPolicyListToJSONTyped = PaginatedGeoIPPolicyListToJSONTyped;
...
function PaginatedGeoIPPolicyListToJSON(json) {
    return PaginatedGeoIPPolicyListToJSONTyped(json, false);
}
function PaginatedGeoIPPolicyListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PaginatedGeoIPPolicyList.js.map