...
exports.ConnectionTokenRequestToJSONTyped = ConnectionTokenRequestToJSONTyped;
/**
...
function ConnectionTokenRequestToJSON(json) {
    return ConnectionTokenRequestToJSONTyped(json, false);
}
function ConnectionTokenRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=ConnectionTokenRequest.js.map