...
exports.instanceOfPatchedFlowRequest = instanceOfPatchedFlowRequest;
exports.PatchedFlowRequestFromJSON = PatchedFlowRequestFromJSON;
...
exports.PatchedFlowRequestToJSONTyped = PatchedFlowRequestToJSONTyped;
 ...
 */
function instanceOfPatchedFlowRequest(value) {
    return true;
}
function PatchedFlowRequestFromJSON(json) {
    return PatchedFlowRequestFromJSONTyped(json, false);
}
function PatchedFlowRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
        ...
        'designation': json['designation'] == null ? undefined : (0, FlowDesignationEnum_1.FlowDesignationEnumFromJSON)(json['designation']),
        ...
        'layout': json['layout'] == null ? undefined : (0, FlowLayoutEnum_1.FlowLayoutEnumFromJSON)(json['layout']),
        'deniedAction': json['denied_action'] == null ? undefined : (0, DeniedActionEnum_1.DeniedActionEnumFromJSON)(json['denied_action']),
        'authentication': json['authentication'] == null ? undefined : (0, AuthenticationEnum_1.AuthenticationEnumFromJSON)(json['authentication']),
    };
}
function PatchedFlowRequestToJSON(json) {
    return PatchedFlowRequestToJSONTyped(json, false);
}
function PatchedFlowRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PatchedFlowRequest.js.map