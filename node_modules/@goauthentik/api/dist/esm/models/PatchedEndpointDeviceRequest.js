...
exports.PatchedEndpointDeviceRequestToJSONTyped = PatchedEndpointDeviceRequestToJSONTyped;
/**
...
function PatchedEndpointDeviceRequestToJSON(json) {
    return PatchedEndpointDeviceRequestToJSONTyped(json, false);
}
function PatchedEndpointDeviceRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PatchedEndpointDeviceRequest.js.map