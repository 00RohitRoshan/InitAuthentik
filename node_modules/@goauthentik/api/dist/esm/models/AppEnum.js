...
exports.instanceOfAppEnum = instanceOfAppEnum;
...
exports.AppEnumToJSONTyped = AppEnumToJSONTyped;
/**
 *
 * @export
 */
...
function instanceOfAppEnum(value) {
    for (const key in exports.AppEnum) {
        if (Object.prototype.hasOwnProperty.call(exports.AppEnum, key)) {
            if (exports.AppEnum[key] === value) {
                return true;
            }
        }
    }
...
function AppEnumToJSONTyped(value, ignoreDiscriminator) {
    return value;
}
