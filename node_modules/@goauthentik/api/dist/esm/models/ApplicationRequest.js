...
exports.instanceOfApplicationRequest = instanceOfApplicationRequest;
exports.ApplicationRequestFromJSON = ApplicationRequestFromJSON;
...
function ApplicationRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function ApplicationRequestToJSON(json) {
    return ApplicationRequestToJSONTyped(json, false);
}
function ApplicationRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
