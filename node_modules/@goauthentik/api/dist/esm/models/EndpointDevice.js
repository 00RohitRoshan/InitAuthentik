...
exports.EndpointDeviceToJSONTyped = EndpointDeviceToJSONTyped;
/**
...
function EndpointDeviceToJSON(json) {
    return EndpointDeviceToJSONTyped(json, false);
}
function EndpointDeviceToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=EndpointDevice.js.map