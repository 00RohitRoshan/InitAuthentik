...
exports.GoogleWorkspaceProviderUserToJSONTyped = GoogleWorkspaceProviderUserToJSONTyped;
...
function GoogleWorkspaceProviderUserToJSON(json) {
    return GoogleWorkspaceProviderUserToJSONTyped(json, false);
}
function GoogleWorkspaceProviderUserToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=GoogleWorkspaceProviderUser.js.map