...
exports.ConsentPermissionToJSONTyped = ConsentPermissionToJSONTyped;
/**
...
function ConsentPermissionToJSON(json) {
    return ConsentPermissionToJSONTyped(json, false);
}
function ConsentPermissionToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=ConsentPermission.js.map