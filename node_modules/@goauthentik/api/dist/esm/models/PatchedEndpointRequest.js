...
function PatchedEndpointRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'protocol': json['protocol'] == null ? undefined : (0, ProtocolEnum_1.ProtocolEnumFromJSON)(json['protocol']),
        'host': json['host'] == null ? undefined : json['host'],
        'settings': json['settings'] == null ? undefined : json['settings'],
        'propertyMappings': json['property_mappings'] == null ? undefined : json['property_mappings'],
        'authMode': json['auth_mode'] == null ? undefined : (0, AuthModeEnum_1.AuthModeEnumFromJSON)(json['auth_mode']),
        'maximumConnections': json['maximum_connections'] == null ? undefined : json['maximum_connections'],
    };
}
function PatchedEndpointRequestToJSON(json) {
    return PatchedEndpointRequestToJSONTyped(json, false);
}
function PatchedEndpointRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PatchedEndpointRequest.js.map