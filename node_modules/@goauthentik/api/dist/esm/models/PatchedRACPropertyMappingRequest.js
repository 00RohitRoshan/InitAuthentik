...
exports.PatchedRACPropertyMappingRequestToJSONTyped = PatchedRACPropertyMappingRequestToJSONTyped;
/**
...
function PatchedRACPropertyMappingRequestToJSON(json) {
    return PatchedRACPropertyMappingRequestToJSONTyped(json, false);
}
function PatchedRACPropertyMappingRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=PatchedRACPropertyMappingRequest.js.map