 ...
 */
export declare function instanceOfOutpostHealth(value: object): value is OutpostHealth;
...
export declare function OutpostHealthToJSON(json: any): OutpostHealth;
export declare function OutpostHealthToJSONTyped(value?: Omit<OutpostHealth, 'uid' | 'last_seen' | 'version' | 'golang_version' | 'openssl_enabled' | 'openssl_version' | 'fips_enabled' | 'version_should' | 'version_outdated' | 'build_hash' | 'build_hash_should' | 'hostname'> | null, ignoreDiscriminator?: boolean): any;
//# sourceMappingURL=OutpostHealth.d.ts.map