...
exports.LDAPProviderRequestToJSONTyped = LDAPProviderRequestToJSONTyped;
...
function LDAPProviderRequestToJSON(json) {
    return LDAPProviderRequestToJSONTyped(json, false);
}
function LDAPProviderRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=LDAPProviderRequest.js.map