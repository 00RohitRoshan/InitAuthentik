...
exports.OAuth2ProviderFromJSON = OAuth2ProviderFromJSON;
exports.OAuth2ProviderFromJSONTyped = OAuth2ProviderFromJSONTyped;
exports.OAuth2ProviderToJSON = OAuth2ProviderToJSON;
exports.OAuth2ProviderToJSONTyped = OAuth2ProviderToJSONTyped;
 ...
 */
function instanceOfOAuth2Provider(value) {
...
function OAuth2ProviderFromJSON(json) {
    return OAuth2ProviderFromJSONTyped(json, false);
}
function OAuth2ProviderFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function OAuth2ProviderToJSON(json) {
    return OAuth2ProviderToJSONTyped(json, false);
}
function OAuth2ProviderToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
