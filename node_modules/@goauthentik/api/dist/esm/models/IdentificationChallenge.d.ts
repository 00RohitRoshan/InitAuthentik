 ...
 */
export declare function instanceOfIdentificationChallenge(value: object): value is IdentificationChallenge;
export declare function IdentificationChallengeFromJSON(json: any): IdentificationChallenge;
export declare function IdentificationChallengeFromJSONTyped(json: any, ignoreDiscriminator: boolean): IdentificationChallenge;
export declare function IdentificationChallengeToJSON(json: any): IdentificationChallenge;
export declare function IdentificationChallengeToJSONTyped(value?: IdentificationChallenge | null, ignoreDiscriminator?: boolean): any;
//# sourceMappingURL=IdentificationChallenge.d.ts.map