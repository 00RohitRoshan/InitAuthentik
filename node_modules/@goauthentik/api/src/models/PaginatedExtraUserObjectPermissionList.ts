...
import {
    ...
    ExtraUserObjectPermissionToJSONTyped,
 ...
 */
export function instanceOfPaginatedExtraUserObjectPermissionList(value: object): value is PaginatedExtraUserObjectPermissionList {
...
export function PaginatedExtraUserObjectPermissionListToJSON(json: any): PaginatedExtraUserObjectPermissionList {
    return PaginatedExtraUserObjectPermissionListToJSONTyped(json, false);
}

export function PaginatedExtraUserObjectPermissionListToJSONTyped(value?: PaginatedExtraUserObjectPermissionList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
