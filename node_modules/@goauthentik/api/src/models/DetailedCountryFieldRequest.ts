 ...
 */
export function instanceOfDetailedCountryFieldRequest(value: object): value is DetailedCountryFieldRequest {
...
export function DetailedCountryFieldRequestToJSON(json: any): DetailedCountryFieldRequest {
    return DetailedCountryFieldRequestToJSONTyped(json, false);
}

export function DetailedCountryFieldRequestToJSONTyped(value?: DetailedCountryFieldRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
