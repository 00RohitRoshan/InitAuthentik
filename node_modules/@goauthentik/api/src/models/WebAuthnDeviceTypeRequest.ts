 ...
 */
export function instanceOfWebAuthnDeviceTypeRequest(value: object): value is WebAuthnDeviceTypeRequest {
...
export function WebAuthnDeviceTypeRequestToJSON(json: any): WebAuthnDeviceTypeRequest {
    return WebAuthnDeviceTypeRequestToJSONTyped(json, false);
}

export function WebAuthnDeviceTypeRequestToJSONTyped(value?: WebAuthnDeviceTypeRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
