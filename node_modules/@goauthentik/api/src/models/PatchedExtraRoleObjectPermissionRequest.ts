 ...
 */
export function instanceOfPatchedExtraRoleObjectPermissionRequest(value: object): value is PatchedExtraRoleObjectPermissionRequest {
    return true;
}
...
export function PatchedExtraRoleObjectPermissionRequestToJSON(json: any): PatchedExtraRoleObjectPermissionRequest {
    return PatchedExtraRoleObjectPermissionRequestToJSONTyped(json, false);
}

export function PatchedExtraRoleObjectPermissionRequestToJSONTyped(value?: PatchedExtraRoleObjectPermissionRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
