 ...
 */
export function instanceOfFlowSetRequest(value: object): value is FlowSetRequest {
...
export function FlowSetRequestToJSON(json: any): FlowSetRequest {
    return FlowSetRequestToJSONTyped(json, false);
}

export function FlowSetRequestToJSONTyped(value?: FlowSetRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
