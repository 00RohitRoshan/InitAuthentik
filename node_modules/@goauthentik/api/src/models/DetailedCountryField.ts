 ...
 */
export function instanceOfDetailedCountryField(value: object): value is DetailedCountryField {
...
export function DetailedCountryFieldToJSON(json: any): DetailedCountryField {
    return DetailedCountryFieldToJSONTyped(json, false);
}

export function DetailedCountryFieldToJSONTyped(value?: DetailedCountryField | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
