...
import {
    ...
    UserAssignedObjectPermissionToJSONTyped,
 ...
 */
export function instanceOfPaginatedUserAssignedObjectPermissionList(value: object): value is PaginatedUserAssignedObjectPermissionList {
...
export function PaginatedUserAssignedObjectPermissionListToJSON(json: any): PaginatedUserAssignedObjectPermissionList {
    return PaginatedUserAssignedObjectPermissionListToJSONTyped(json, false);
}

export function PaginatedUserAssignedObjectPermissionListToJSONTyped(value?: PaginatedUserAssignedObjectPermissionList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
