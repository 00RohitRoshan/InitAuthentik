 ...
 */
export function instanceOfUserGroupRequest(value: object): value is UserGroupRequest {
...
export function UserGroupRequestToJSON(json: any): UserGroupRequest {
    return UserGroupRequestToJSONTyped(json, false);
}

export function UserGroupRequestToJSONTyped(value?: UserGroupRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
