...
export function instanceOfNameIdPolicyEnum(value: any): boolean {
    for (const key in NameIdPolicyEnum) {
        if (Object.prototype.hasOwnProperty.call(NameIdPolicyEnum, key)) {
            if (NameIdPolicyEnum[key as keyof typeof NameIdPolicyEnum] === value) {
                return true;
            }
        }
    }
...
export function NameIdPolicyEnumFromJSONTyped(json: any, ignoreDiscriminator: boolean): NameIdPolicyEnum {
    return json as NameIdPolicyEnum;
}

export function NameIdPolicyEnumToJSON(value?: NameIdPolicyEnum | null): any {
    return value as any;
}

export function NameIdPolicyEnumToJSONTyped(value: any, ignoreDiscriminator: boolean): NameIdPolicyEnum {
    return value as NameIdPolicyEnum;
}
