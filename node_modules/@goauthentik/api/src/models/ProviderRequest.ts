...
export function ProviderRequestToJSON(json: any): ProviderRequest {
    return ProviderRequestToJSONTyped(json, false);
}

export function ProviderRequestToJSONTyped(value?: ProviderRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
